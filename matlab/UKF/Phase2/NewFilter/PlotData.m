...
subplot(3,1,1);
plot(output.time_lapsed,[output.velocity_NED(:,1),output.velocity_NED(:,1)+2*sqrt(output.state_variances(:,4)),output.velocity_NED(:,1)-2*sqrt(output.state_variances(:,4))]);
grid on;
...
subplot(3,1,2);
plot(output.time_lapsed,[output.velocity_NED(:,2),output.velocity_NED(:,2)+2*sqrt(output.state_variances(:,5)),output.velocity_NED(:,2)-2*sqrt(output.state_variances(:,5))]);
grid on;
ylabel('East (m/s)');
xlabel('time (sec)');
legend('estimate','upper 95% bound','lower 95% bound');
...
subplot(3,1,3);
plot(output.time_lapsed,[output.velocity_NED(:,3),output.velocity_NED(:,3)+2*sqrt(output.state_variances(:,6)),output.velocity_NED(:,3)-2*sqrt(output.state_variances(:,6))]);
grid on;
ylabel('Down (m/s)');
xlabel('time (sec)');
legend('estimate','upper 95% bound','lower 95% bound');
...
subplot(3,1,1);
plot(output.time_lapsed,[output.position_NED(:,1),output.position_NED(:,1)+2*sqrt(output.state_variances(:,7)),output.position_NED(:,1)-2*sqrt(output.state_variances(:,7))]);
grid on;
...
subplot(3,1,2);
plot(output.time_lapsed,[output.position_NED(:,2),output.position_NED(:,2)+2*sqrt(output.state_variances(:,8)),output.position_NED(:,2)-2*sqrt(output.state_variances(:,8))]);
grid on;
ylabel('East (m)');
xlabel('time (sec)');
legend('estimate','upper 95% bound','lower 95% bound');
...
subplot(3,1,3);
plot(output.time_lapsed,[output.position_NED(:,3),output.position_NED(:,3)+2*sqrt(output.state_variances(:,9)),output.position_NED(:,3)-2*sqrt(output.state_variances(:,9))]);
grid on;
ylabel('Down (m)');
xlabel('time (sec)');
legend('estimate','upper 95% bound','lower 95% bound');
...
subplot(3,1,1);
plot(output.time_lapsed,(1/output.dt)*[output.gyro_bias(:,1),output.gyro_bias(:,1)+2*sqrt(output.state_variances(:,10)),output.gyro_bias(:,1)-2*sqrt(output.state_variances(:,10))]*rad2deg);%%output.gyro_bias(:,1)*rad2deg);
...
subplot(3,1,2);
plot(output.time_lapsed,(1/output.dt)*[output.gyro_bias(:,2),output.gyro_bias(:,2)+2*sqrt(output.state_variances(:,11)),output.gyro_bias(:,2)-2*sqrt(output.state_variances(:,11))]*rad2deg);
...
subplot(3,1,3);
plot(output.time_lapsed,(1/output.dt)*[output.gyro_bias(:,3),output.gyro_bias(:,3)+2*sqrt(output.state_variances(:,12)),output.gyro_bias(:,3)-2*sqrt(output.state_variances(:,12))]*rad2deg);
...
subplot(3,1,1);
plot(output.time_lapsed,(1/output.dt)*[output.accel_bias(:,1),output.accel_bias(:,1)+2*sqrt(output.state_variances(:,13)),output.accel_bias(:,1)-2*sqrt(output.state_variances(:,13))]);
...
subplot(3,1,2);
plot(output.time_lapsed,(1/output.dt)*[output.accel_bias(:,2),output.accel_bias(:,2)+2*sqrt(output.state_variances(:,14)),output.accel_bias(:,2)-2*sqrt(output.state_variances(:,14))]);
minVal = (1/output.dt)*min(output.accel_bias(:,1))-margin;
maxVal = (1/output.dt)*max(output.accel_bias(:,1))+margin;
ylim([minVal maxVal]);
grid on;
...
subplot(3,1,3);
plot(output.time_lapsed,(1/output.dt)*[output.accel_bias(:,3),output.accel_bias(:,3)+2*sqrt(output.state_variances(:,15)),output.accel_bias(:,3)-2*sqrt(output.state_variances(:,15))]);
minVal = (1/output.dt)*min(output.accel_bias(:,1))-margin;
maxVal = (1/output.dt)*max(output.accel_bias(:,1))+margin;
ylim([minVal maxVal]);
grid on;
...
if (output.magFuseMethod <= 1)
    ...
    subplot(3,1,1);
    plot(output.time_lapsed',[output.mag_XYZ(:,1),output.mag_XYZ(:,1)+2*sqrt(output.state_variances(:,19)),output.mag_XYZ(:,1)-2*sqrt(output.state_variances(:,19))]);
    grid on;
    ...
    subplot(3,1,2);
    plot(output.time_lapsed',[output.mag_XYZ(:,2),output.mag_XYZ(:,2)+2*sqrt(output.state_variances(:,20)),output.mag_XYZ(:,2)-2*sqrt(output.state_variances(:,20))]);
    grid on;
    ylabel('Y bias (gauss)');
    xlabel('time (sec)');
    legend('estimate','upper 95% bound','lower 95% bound');
    ...
    subplot(3,1,3);
    plot(output.time_lapsed',[output.mag_XYZ(:,3),output.mag_XYZ(:,3)+2*sqrt(output.state_variances(:,21)),output.mag_XYZ(:,3)-2*sqrt(output.state_variances(:,21))]);
    grid on;
    ylabel('Z bias (gauss)');
    xlabel('time (sec)');
    legend('estimate','upper 95% bound','lower 95% bound');
...
if (output.magFuseMethod <= 1)
    ...
    subplot(4,1,1);
    plot(output.time_lapsed',[output.mag_NED(:,1),output.mag_NED(:,1)+2*sqrt(output.state_variances(:,16)),output.mag_NED(:,1)-2*sqrt(output.state_variances(:,16))]);
    ...
    subplot(4,1,2);
    plot(output.time_lapsed',[output.mag_NED(:,2),output.mag_NED(:,2)+2*sqrt(output.state_variances(:,17)),output.mag_NED(:,2)-2*sqrt(output.state_variances(:,17))]);
    ...
    subplot(4,1,3);
    plot(output.time_lapsed',[output.mag_NED(:,3),output.mag_NED(:,3)+2*sqrt(output.state_variances(:,18)),output.mag_NED(:,3)-2*sqrt(output.state_variances(:,18))]);
    grid on;
...
%% plot height innovations
if isfield(output.innovations,'hgtInnov')
    figure('Units','Pixels','Position',plotDimensions,'PaperOrientation','portrait');
    h=gcf;
    set(h,'PaperOrientation','portrait');
    set(h,'PaperUnits','normalized');
    ...
    plot(output.innovations.hgt_time_lapsed',[output.innovations.hgtInnov(:),sqrt(output.innovations.hgtInnovVar(:)),-sqrt(output.innovations.hgtInnovVar(:))]);
    titleText=strcat({'Height Innovations and Variances'},runIdentifier);
    title(titleText);
    grid on;
    ylabel('Up (m)');
    xlabel('time (sec)');
