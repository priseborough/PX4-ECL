...
for s = 1:(2*param.ukf.L+1)
    ...
    % measurement
    psi_m(:,s) = sigma_x_a(19:21,s) + Tnb * sigma_x_a(16:18,s);
...
Pyy = diag([1;1;1]*param.fusion.magFieldError^2);
...
if (innovNorm2 > param.fusion.magFieldGate^2)
    return;
end
