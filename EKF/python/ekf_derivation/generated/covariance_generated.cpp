...
nextP(4,24) = P(0,24)*PS72 + P(1,24)*PS62 - P(13,24)*PS44 + P(14,24)*PS140 - P(15,24)*PS139 + P(2,24)*PS60 - P(3,24)*PS74 + P(4,24);
nextP(5,24) = P(0,24)*PS74 - P(1,24)*PS60 - P(13,24)*PS162 - P(14,24)*PS65 + P(15,24)*PS160 + P(2,24)*PS62 + P(3,24)*PS72 + P(5,24);
nextP(6,24) = P(0,24)*PS60 + P(1,24)*PS74 + P(13,24)*PS166 - P(14,24)*PS165 - P(15,24)*PS70 - P(2,24)*PS72 + P(3,24)*PS62 + P(6,24);
