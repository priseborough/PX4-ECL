...
syms yaw_offset real % initial yaw angle : rad
...
states=[mx_bias;my_bias;mz_bias;yaw_offset];

% rotate quaternions by initial yaw angle
quat = QuatMult([cos(yaw_offset),0,0,sin(yaw_offset)],[q0,q1,q2,q3]);
...
% observation
mag_obs = transpose(Tbn)*[mn;me;md] + [mx_bias;my_bias;mz_bias];
